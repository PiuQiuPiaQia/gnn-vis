...
from physics_v2.gate_runner import evaluate_gate, gate_result_to_payload, write_gate_report
from physics_v2.metrics import compute_anisotropy_ratio_km
...
def run_physics_comparison_v2(output_dir: Path | None = None) -> Dict[str, Any]:
    ...
    from physics_v2.comparison_core import run_physics_comparison
    ...
    gate_path = output_dir / "physics_v2_gate_report.json"
